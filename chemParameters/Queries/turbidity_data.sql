...
/*  
statewide totals FOR TURBIDITY (REFERENCING PAGE 43)
...
*/
DROP TABLE IF EXISTS TEMP_TABLE_TURBIDITY;

CREATE TABLE TEMP_TABLE_TURBIDITY (
...
/* STATEWIDE TOTAL */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
    0,
    COUNT(*) as 'COUNT',
    MIN(VALUE) AS 'MIN',
...
WHERE MBASN = 1 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 2 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 2 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 3 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 3 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 4 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 4 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 5 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 5 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 6 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 6 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 7 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 7 AND CHEMPARAMETER = 'Turbidity'
;
/* MAJOR BASIN 8 */
INSERT INTO TEMP_TABLE_TURBIDITY
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 8 AND CHEMPARAMETER = 'Turbidity'
;

/* DISPLAY FINAL TABLE */
SELECT *
FROM TEMP_TABLE_TURBIDITY;
