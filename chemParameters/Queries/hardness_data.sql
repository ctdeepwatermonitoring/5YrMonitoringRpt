...
/*  
statewide totals FOR HARDNESS (REFERENCING PAGE 43)
...
*/
DROP TABLE IF EXISTS TEMP_TABLE_HARDNESS;

CREATE TABLE TEMP_TABLE_HARDNESS (
...
/* STATEWIDE TOTAL */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
    0,
    COUNT(*) as 'COUNT',
    MIN(VALUE) AS 'MIN',
...
WHERE MBASN = 1 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 2 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 2 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 3 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 3 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 4 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 4 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 5 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 5 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 6 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 6 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 7 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 7 AND CHEMPARAMETER = 'Hardness'
;
/* MAJOR BASIN 8 */
INSERT INTO TEMP_TABLE_HARDNESS
SELECT
...
INNER JOIN SITES ON SITES.STA_SEQ = CHEMDATA.STA_SEQ
INNER JOIN BASIN ON BASIN.SBASN = SITES.SBASN
WHERE MBASN = 8 AND CHEMPARAMETER = 'Hardness'
;

/* DISPLAY FINAL TABLE */
SELECT *
FROM TEMP_TABLE_HARDNESS;
